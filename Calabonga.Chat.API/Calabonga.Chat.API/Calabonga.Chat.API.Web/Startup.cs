using Calabonga.Chat.API.Web.AppStart.Configures;
using Calabonga.Chat.API.Web.AppStart.ConfigureServices;
using Calabonga.Chat.API.Web.Infrastructure.DependencyInjection;
...
namespace Calabonga.Chat.API.Web
{
    /// <summary>
    /// Startup entry
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            ConfigureServicesSignalR.ConfigureServices(services);
